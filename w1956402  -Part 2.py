...
printings_5 = looping ( 0 , list_1 , count_progress  , count_trailer  , count_retriever  , count_exclude )  # Print the elements in list_1
...
for elements in list_4 : # To iterate the elements in list_4
    ...
    print ( list_4[ number ][ 0 ] , " - " ,end = " " )  # To print the first element of each list in the index called number

    for data in list_4[ number ][ 1 : 4 ]  : # To iterate the elements in range 1 to 3 in the list in index called number
